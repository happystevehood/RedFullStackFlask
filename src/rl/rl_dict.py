...
OUTPUT_CONFIGS = [
    ...
    {
        'id': 'station_hist_generic_part1',
        'name': 'Station Histograms (1-6)',
        'function_name': 'CreateStationHistogramsPart1', # Wrapper
        'is_competitor_specific': False,
        'filename_template': '{EVENT_NAME_SLUG}_StationHist_Part1.png',
        'output_dir_const': 'PNG_GENERIC_DIR',
        'output_type': 'png',
        'requires_category_data': False,
        'generates_multiple_files': False,
        'html_string_template': ("<p><b>Station Time Distribution (Stations 1-6):</b> This grid shows how athletes' finish times were distributed for the first half of the race. Each histogram displays the frequency of different completion times (in seconds) for a specific station, using data from the fastest 95% of finishers for that station to provide a clear view of the main competitive field.</p>"),
        'is_placeholder_ready': False, 
        'load_priority': 4
    },
    {
        'id': 'station_hist_generic_part2',
        'name': 'Station Histograms (7-12)',
        'function_name': 'CreateStationHistogramsPart2', # Wrapper
        'is_competitor_specific': False,
        'filename_template': '{EVENT_NAME_SLUG}_StationHist_Part2.png',
        'output_dir_const': 'PNG_GENERIC_DIR',
        'output_type': 'png',
        'requires_category_data': False, # Works with and without categories
        'generates_multiple_files': False,
        'html_string_template': ("<p><b>Station Time Distribution (Stations 7-12):</b> This grid shows how athletes' finish times were distributed for the second half of the race. Each histogram displays the frequency of different completion times (in seconds) for a specific station, using data from the fastest 95% of finishers for that station to focus on the main competitive field's performance.</p>"),
        'is_placeholder_ready': False, 
        'load_priority': 5
    },      
    {
    ...
    },
    {
        ...
        'is_placeholder_ready': True, 
        'load_priority': 9 # Highest PRIORITY 
    },
    {
    ...
    {
        'id': 'station_hist_comp_part1',
        'name': 'Station Histograms (1-6)',
        'function_name': 'CreateStationHistogramsPart1', # A new wrapper needed
        'is_competitor_specific': True,
        'filename_template': '{EVENT_NAME_SLUG}_{COMPETITOR_NAME_SLUG}_StationHist_Part1.png',
        'output_dir_const': 'PNG_COMP_DIR',
        'output_type': 'png',
        'requires_category_data': False,
        'generates_multiple_files': False,
        'html_string_template': ("<p><b>Your Performance vs. Distribution (Stations 1-6):</b> This grid compares your performance to the field for the first half of the race. Each histogram shows the distribution of all finisher times, while the vertical line and text in the top-right corner mark your specific time and percentile rank for that station. Use this to see where you stood relative to the competition early in the event.</p>"),
        'is_placeholder_ready': False, 
        'load_priority': 4
    },
    {
        'id': 'station_hist_comp_part2',
        'name': 'Station Histograms (7-12)',
        'function_name': 'CreateStationHistogramsPart2', # Same wrapper
        'is_competitor_specific': True,
        'filename_template': '{EVENT_NAME_SLUG}_{COMPETITOR_NAME_SLUG}_StationHist_Part2.png',
        'output_dir_const': 'PNG_COMP_DIR',
        'output_type': 'png',
        'requires_category_data': False, # Works with and without categories
        'generates_multiple_files': False,
        'html_string_template': ("<p><b>Your Performance vs. Distribution (Stations 7-12):</b> This grid compares your performance to the field for the crucial second half of the race. Each histogram shows the overall distribution of finisher times. The vertical line and text in the top-right corner pinpoint your specific time and percentile rank, highlighting where you gained or lost ground as fatigue set in.</p>"),
        'is_placeholder_ready': False, 
        'load_priority': 5
    },
    {
